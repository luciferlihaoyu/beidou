...
def _project_out(p: AiProject, novel: Novel | None = None, chapter_count: int = 0) -> dict:
    return {
        ...
        "deconstruct_hint": p.deconstruct_hint or "",
        "deconstruct_draft": json.loads(p.deconstruct_draft_json) if p.deconstruct_draft_json else None,
        "setup_llm": p.setup_llm or "",
        "outline_llm": p.outline_llm or "",
        "chapter_llm": p.chapter_llm or "",
        "summary_llm": p.summary_llm or "",
        "review_llm": p.review_llm or "",
